...
function Slider() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#EEF5F7] py-12">
      <p className="text-center mb-8 px-4 sm:px-0 text-sm sm:text-base font-semibold max-w-xl mx-auto">
        Learn from 350+ leading universities and companies with us
      </p>

      <div className="absolute top-0 left-0 w-16 sm:w-32 h-full z-10 bg-gradient-to-r from-[#EEF5F7] to-transparent pointer-events-none" />
      <div className="absolute top-0 right-0 w-16 sm:w-32 h-full z-10 bg-gradient-to-l from-[#EEF5F7] to-transparent pointer-events-none" />
